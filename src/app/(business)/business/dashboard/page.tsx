...
export default async function BusinessDashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* ── AD BANNER ── */}
      <div className="relative rounded-2xl overflow-hidden border border-[#E7E2EF] bg-gradient-to-r from-[#0F3D36] to-[#1a5a4e]">
        ...
        <div className="px-5 pt-8 pb-5 flex items-end justify-between gap-4">
          <div>
            <p className="text-xs font-semibold text-[#28D96D] mb-1 uppercase tracking-wide">Sponsored</p>
            <p className="text-base font-black text-white leading-tight mb-1">
              Promote your business to top pros
            </p>
            <p className="text-xs text-white/50 leading-relaxed">
              Featured placement puts your shifts and brand at the top of every pro's feed across Kurdistan
            </p>
          </div>
          <div className="shrink-0 w-12 h-12 rounded-2xl bg-[#28D96D]/20 flex items-center justify-center">
            <svg className="w-6 h-6 text-[#28D96D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="px-5 pb-4">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#28D96D] text-[#0F3D36] text-xs font-bold hover:bg-[#22c45e] transition-colors"
          >
            Advertise with us →
          </a>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        {/* Fees — links to Finance page */}
        <Link href="/business/finance" className="group rounded-2xl bg-[#0F3D36] p-5 hover:bg-[#1a5c4a] transition-colors">
          <div className="flex items-start justify-between mb-4">
